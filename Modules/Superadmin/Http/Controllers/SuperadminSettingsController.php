...
class SuperadminSettingsController extends BaseController
{
    ...
    public function edit()
    {
        ...
        $default_values = [
            ...
            'MPESA_ENV' => $is_demo ? null : env('MPESA_ENV'),
            ...
            'MPESA_SHORTCODE_TYPE' => $is_demo ? null : env('MPESA_SHORTCODE_TYPE'),
            'MPESA_BUY_GOODS_TILL' => $is_demo ? null : env('MPESA_BUY_GOODS_TILL'),
            'MPESA_PASSKEY' => $is_demo ? null : env('MPESA_PASSKEY'),
            'MAPESA_C2B_VERSION' => $is_demo ? null : env('MAPESA_C2B_VERSION'),
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            $env_settings =  $request->only(['APP_NAME', 'APP_TITLE',
                ...
                'MPESA_SHORTCODE', 'MPESA_SHORTCODE_TYPE', 'MPESA_BUY_GOODS_TILL',
                'MPESA_PASSKEY', 'MAPESA_C2B_VERSION',
