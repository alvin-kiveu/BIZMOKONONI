...
Route::group(['middleware' => ['web', 'SetSessionData', 'auth', 'language', 'timezone', 'AdminSidebarMenu'],
    'namespace' => 'Modules\Superadmin\Http\Controllers'], function () {
        ...
        Route::post('/subscription/mpesapay', 'SubscriptionController@mpesaPay');
        Route::get('/subscription/mpesa-callback', 'SubscriptionController@mpesaCallback');
        Route::post('/subscription/mpesa-verifypayment', 'SubscriptionController@mpesaVerifyPayment');
