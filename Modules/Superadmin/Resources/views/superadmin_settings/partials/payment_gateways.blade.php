<div class="pos-tab-content">
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="form-group">
            	{!! Form::label('MPESA_ENV', __('superadmin::lang.mpesa_env') . ':') !!}
            	{!! Form::select('MPESA_ENV',['sandbox' => 'Sandbox', 'production' => 'Production'],  $default_values['MPESA_ENV'], ['class' => 'form-control','placeholder' => __('messages.please_select')]); !!}
            </div>
        </div>
    	<div class="col-xs-6">
            <div class="form-group">
            	{!! Form::label('MPESA_CONSUMER_KEY', __('superadmin::lang.mpesa_consumer_key') . ':') !!}
            	{!! Form::text('MPESA_CONSUMER_KEY', $default_values['MPESA_CONSUMER_KEY'], ['class' => 'form-control','placeholder' => __('superadmin::lang.mpesa_consumer_key')]); !!}
            </div>
        </div>
        <div class="col-xs-6">
            <div class="form-group">
            	{!! Form::label('MPESA_CONSUMER_SECRET', __('superadmin::lang.mpesa_consumer_secret') . ':') !!}
            	{!! Form::text('MPESA_CONSUMER_SECRET', $default_values['MPESA_CONSUMER_SECRET'], ['class' => 'form-control','placeholder' => __('superadmin::lang.mpesa_consumer_secret')]); !!}
            </div>
        </div>
        <div class="col-xs-6">
            <div class="form-group">
            	{!! Form::label('MPESA_SHORTCODE', __('superadmin::lang.mpesa_shortcode') . ':') !!}
            	{!! Form::text('MPESA_SHORTCODE', $default_values['MPESA_SHORTCODE'], ['class' => 'form-control','placeholder' => __('superadmin::lang.mpesa_shortcode')]); !!}
            </div>
        </div>

        <div class="col-xs-6">
            <div class="form-group">
            	{!! Form::label('MPESA_PASSKEY', __('superadmin::lang.mpesa_passkey') . ':') !!}
            	{!! Form::text('MPESA_PASSKEY', $default_values['MPESA_PASSKEY'], ['class' => 'form-control','placeholder' => __('superadmin::lang.mpesa_passkey')]); !!}
            </div>
        </div>

        <div class="col-xs-6">
            <div class="form-group">
            	{!! Form::label('MPESA_SHORTCODE_TYPE', __('superadmin::lang.mpesa_short_type') . ':') !!}
                {!! Form::select('MPESA_SHORTCODE_TYPE',['Paybill' => 'Paybill', 'BuyGoods' => 'BuyGoods Till Number'],  $default_values['MPESA_SHORTCODE_TYPE'], ['class' => 'form-control','placeholder' => __('messages.please_select')]); !!}
            </div>
        </div>

        <div class="col-xs-6">
            <div class="form-group">
            	{!! Form::label('MPESA_BUY_GOODS_TILL', __('superadmin::lang.mpesa_buy_goods_till') . ':') !!}
            	{!! Form::text('MPESA_BUY_GOODS_TILL', $default_values['MPESA_BUY_GOODS_TILL'], ['class' => 'form-control','placeholder' => __('superadmin::lang.mpesa_buy_goods_till')]); !!}
            </div>
        </div>

        <div class="col-xs-12">
            <div class="form-group">
            	{!! Form::label('MAPESA_C2B_VERSION', __('superadmin::lang.mpesa_c2b_version') . ':') !!}
                {!! Form::select('MAPESA_C2B_VERSION',['v1' => 'V1', 'v2' => 'V2'],  $default_values['MAPESA_C2B_VERSION'], ['class' => 'form-control','placeholder' => __('messages.please_select')]); !!}
            </div>
        </div>
