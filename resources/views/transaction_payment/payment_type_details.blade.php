...
<div class="payment_details_div @if( $payment_line->method !== 'mpesa' ) {{ 'hide' }} @endif" data-type="mpesa" >
	<div class="col-md-12">
		<div class="form-group">
			{!! Form::label("mpesa_number",__('lang_v1.mpesa_number')) !!}
			{!! Form::text("mpesa_number", $payment_line->mpesa_number, ['class' => 'form-control', 'placeholder' => __('lang_v1.mpesa_number')]); !!}
		</div>
	</div>
</div>
